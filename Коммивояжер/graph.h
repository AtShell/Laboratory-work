...
Graph<int> makeGraph(){
	...
	cout << "Количество вершин: "; cin >> amountVerts; cout << endl; // ввод количества рёбер графа в переменную amountVerts
	cout << "Количество ребер : "; cin >> amountEdges; cout << endl; // ввод количества рёбер графа в переменную amountEdges
